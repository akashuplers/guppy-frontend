...
const SituationActionModifyPopup = ({
  open,
  onClose = () => {},
  modifyItemObj,
  onModify = () => {},
  ...
  useEffect(() => {
    ...
    // primaryWhos
    setPrimaryWhoOptions(primaryWhos);
    setPrimaryWhoSelectedOptions(primaryWhos);
    //secondaryWhos
    setSecondaryWhoOptions(secondaryWhos);
    setSecondaryWhoSelectedOptions(secondaryWhos);
    // primaryWhats
    setPrimaryWhatOptions(primaryWhats);
    setPrimaryWhatSelectedOptions(primaryWhats);
    //secondaryWhats
    setSecondaryWhatOptions(secondaryWhats);
    setSecondaryWhatSelectedOptions(secondaryWhats);
    // primaryWheres
    setPrimaryWhereOptions(primaryWheres);
    setPrimaryWhereSelectedOptions(primaryWheres);
    //secondaryWheres
    setSecondaryWhereOptions(secondaryWheres);
    setSecondaryWhereSelectedOptions(secondaryWheres);
  }, []);
...
export default SituationActionModifyPopup;